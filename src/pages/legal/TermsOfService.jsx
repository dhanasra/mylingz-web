...
const TermsOfService = () => {
  ...
  return (
    <Box sx={{
      ...
      <Box height={8}/>
      <Typography>If you have any questions about these Terms, please contact us at <a href="mailto:dhana.spiderlingz@gmail.com" style={{ color: 'blue', textDecoration: 'underline' }}>dhana.spiderlingz@gmail.com</a>.</Typography>
